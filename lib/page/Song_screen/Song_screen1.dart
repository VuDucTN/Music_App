...
class SongScreen1 extends StatefulWidget {
  const SongScreen1({Key? key}) : super(key: key);
  static const routeName = "/Song1";

  @override
  State<SongScreen1> createState() => _SongScreenState();
}

class _SongScreenState extends State<SongScreen1> {
